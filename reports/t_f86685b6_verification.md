...
## t_f86685b6 verification_evidence（実測のみ）

### t_f86685b6 検証1: 実データ収集+生成
$ python3 scripts/value_feed.py
=> value-feed.json 生成: 10 件 -> data/value-feed.json
=> FEED.md 生成: FEED.md

### t_f86685b6 検証2: JSONスキーマ+価値選抜ルール検証
